exemple: pays.o libisentlib.a
	gcc -Wall pays.o -o pays libisentlib.a -lm -lglut -lGL -lX11
...
exemple.o: pays.c GfxLib.h BmpLib.h ESLib.h
	gcc -Wall -c pays.c
...
deepclean: clean
	rm -f pays exempleTortue libisentlib.a
